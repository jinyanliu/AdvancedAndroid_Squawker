...
public class FollowingPreferenceFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    /**
     * Triggered when shared preferences changes. This will be triggered when a person is followed or un-followed
     *
    ...
    public void onSharedPreferenceChanged(final SharedPreferences sharedPreferences, final String key) {
        ...
        if (preference != null && preference instanceof SwitchPreferenceCompat) {
            ...
            if (isOn) {
                // The preference key matches the following key for the associated instructor in FCM. For example, the key for Lyla is key_lyla (as seen in
